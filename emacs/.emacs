;; -*- Emacs-Lisp -*-
;; Time-stamp: <2013-03-09 16:30:09 Saturday by work>
...
(require 'my-development-settings)

;;(require 'my-git-emacs-settings)
;;(require 'my-magit-settings)
;;(require 'my-egg-settings)
...
(define-key-list
 ...
 `(("C-x G l" goto-my-emacs-lisps-dir)
   ...
   ("M-i" split-window-horizontally)
   ("M-o" next-multiframe-window)
   ("C-o" previous-multiframe-window)
   ("C-x g" goto-line)
...
(define-key global-map (kbd "M-0") 'next-buffer)
(define-key global-map (kbd "M-9") 'previous-buffer)
